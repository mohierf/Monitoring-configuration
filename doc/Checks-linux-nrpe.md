...
## Check Linux servers (NRPE checks)
```
   # Install Shinken commands for SNMP checks
   su - shinken
   mkdir /etc/shinken/packs/linux-nrpe
   cp ./Monitoring-configuration-master/packs/linux-nrpe/* /etc/shinken/packs/linux-nrpe/.
